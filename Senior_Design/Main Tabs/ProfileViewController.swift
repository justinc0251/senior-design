...
class ProfileViewController: UIViewController {
    ...
    private func setupProfileHeader() {
        ...
        nameLabel = UILabel()
        nameLabel.text = ""
        nameLabel.font = UIFont(name: "Sen-Regular", size: 28) ?? UIFont.systemFont(ofSize: 28)
        nameLabel.textColor = .black
        nameLabel.translatesAutoresizingMaskIntoConstraints = false
        ...
        joinDateLabel.text = ""
        joinDateLabel.font = UIFont(name: "Sen-Regular", size: 16) ?? UIFont.systemFont(ofSize: 16)
     ...
     private func setupRecentActivity() {
        ...
        activityTitleLabel.font = UIFont(name: "Sen-Regular", size: 18) ?? UIFont.systemFont(ofSize: 18)
    ...
    private func setupStatsView() {
        ...
        let pointsTapGesture = UITapGestureRecognizer(target: self, action: #selector(pointsTapped))
        pointsContainer.addGestureRecognizer(pointsTapGesture)
        pointsContainer.isUserInteractionEnabled = true
    ...
    private func createStatContainer(title: String, subtitle: String) -> UIView {
        ...
        titleLabel.font = UIFont(name: "Sen-Regular", size: 24) ?? UIFont.systemFont(ofSize: 24)
    ...
    private func setupActionButtons() {
        ...
        addFriendsButton.titleLabel?.font = UIFont(name: "Sen-Regular", size: 16) ?? UIFont.systemFont(ofSize: 16)
    ...
    private func generateShareableStatsImage() -> UIImage {
        ...
        let image = renderer.image { context in
            ...
            let headerAttributes: [NSAttributedString.Key: Any] = [
                .font: UIFont(name: "Sen-Bold", size: 32) ?? UIFont.systemFont(ofSize: 32, weight: .bold),
            ...
            if !recentGames.isEmpty {
                ...
                let recentAttributes: [NSAttributedString.Key: Any] = [
                    .font: UIFont(name: "Sen-Regular", size: 20) ?? UIFont.systemFont(ofSize: 20, weight: .medium),
                    .foregroundColor: UIColor.black
                ]
...
class EditProfileViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            cancelButton.bottomAnchor.constraint(lessThanOrEqualTo: contentView.bottomAnchor, constant: -24),
    ...
    @objc private func handleSave() {
        guard let name = nameTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines),
            ...
            showAlert(title: "Error", message: "Name and username cannot be empty")
            return
        }
